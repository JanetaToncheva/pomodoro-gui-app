...
# buttons
start_button = Button(text='Start', fg='black', font=(FONT_NAME, 9, 'bold'), command=start_timer)
start_button.grid(column=1, row=3)

reset_button = Button(text='Reset', fg='black', font=(FONT_NAME, 9, 'bold'), command=reset_timer)
